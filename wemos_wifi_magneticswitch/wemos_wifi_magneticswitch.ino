/***************************************************
  ...
  Script to publish door events to an Adafruit IO feed
...
void setup() {
  ...
  // Door identifier will be part of mac address of device
  doorId = WiFi.macAddress().substring(12,20);
  Serial.println("Door ID: "); Serial.println(doorId);
  
  // Setup MQTT subscription for onoff feed.
  //mqtt.subscribe(&onoffbutton);

  // Setup magnetic switch pin
